...
import {
  ...
  formatDecimal,
  formatPercent,
} from '../../src/common/localization/intlFormatter';
  ...
  return (
    <ScrollView style={CommonStyles.flexPlatformBackground}>
      <TitleDescriptionBorder
        title={formatPercent(25)}
        description={formatPercent.name}
      />
      <TitleDescriptionBorder
        title={formatCurrency(10000)}
        description={formatCurrency.name}
      />
      <TitleDescriptionBorder
        title={formatDecimal(10000)}
        description={formatDecimal.name}
        isLast={true}
      />
    </ScrollView>
  );
