  ...
  return (
    <ScrollView style={CommonStyles.flexPlatformBackground}>
      <TitleDescriptionBorder
        title={dateFromString(new Date()).toString()}
        description={dateFromString.name}
      />
      <TitleDescriptionBorder
        title={dateFromUnknown(new Date())?.toString() || ''}
        description={dateFromUnknown.name}
      />
      <TitleDescriptionBorder
        title={calendarDate(new Date()).toString()}
        description={calendarDate.name}
      />
      <TitleDescriptionBorder
      ...
      />
      <TitleDescriptionBorder
        title={getUnixDate(new Date()).toString()}
        description={getUnixDate.name}
      />
    </ScrollView>
  );
});
